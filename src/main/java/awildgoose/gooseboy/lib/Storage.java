...
public class Storage {
	...
	public int storage_read(Instance instance, int offset, int ptr, int len) {
		if (CrateUtils.doesNotHavePermission(instance, WasmCrate.Permission.STORAGE_READ))
			return 0;
	...
	public int storage_write(Instance instance, int offset, int ptr, int len) {
		if (CrateUtils.doesNotHavePermission(instance, WasmCrate.Permission.STORAGE_WRITE))
			return 0;
