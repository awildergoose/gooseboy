...
public final class Input {
	...
	public int get_key(Instance instance, int key) {
		if (CrateUtils.doesNotHavePermissionAndWarn(instance, GooseboyCrate.Permission.INPUT_KEYBOARD))
			return 0;
	...
	public int get_mouse_button(Instance instance, int button) {
		if (CrateUtils.doesNotHavePermissionAndWarn(instance, GooseboyCrate.Permission.INPUT_MOUSE))
			return 0;
	...
	public int get_mouse_x(Instance instance) {
		if (CrateUtils.doesNotHavePermissionAndWarn(instance, GooseboyCrate.Permission.INPUT_MOUSE_POS))
			return 0;
	...
	public int is_mouse_grabbed(Instance instance) {
		if (CrateUtils.doesNotHavePermissionAndWarn(instance, GooseboyCrate.Permission.INPUT_GRAB_MOUSE))
			return 0;
